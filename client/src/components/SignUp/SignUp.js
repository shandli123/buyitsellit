            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
              ...
              <div className="card-body">
                <form className="registerform" onSubmit={this.handleSubmit}>
                  ...
                  <div className="container-button">
                    <button type="submit" className="btn" style={{ backgroundColor: '#10eeab' }} id="register-submit">Submit</button>
                  </div>

                  <div className="row">
                    <span className="psw">Already have an account? <Link to="/" id="forgot1" style={{ textAlign: 'center' }}> Login now</Link></span>
                  </div>
