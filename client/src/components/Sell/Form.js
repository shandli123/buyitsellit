...
class Form extends Component {
  ...
  submitForm = (e) => {
    ...
    fd.append('desc', e.target[2].value);
    ...
    return (
      <div>
        <form onSubmit={this.submitForm}>
           ...
           */}
          <div className="form-group">
            <label htmlFor="exampleFormControlInput1" style= {{ color: '#32be8f' }}>Name Of Item</label>
            <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="eg:Harry Potter Books"></input>
          </div>
          <div className="form-group">
            <label htmlFor="exampleFormControlInput1" style={{ color: '#32be8f' }}>Expected Price(Approx)</label>
            <input type="text" className="form-control" id="exampleFormControlInput1"></input>
          </div>
          <div className="form-group">
            <label htmlFor="exampleFormControlTextarea1" style={{ color: '#32be8f' }}>Short Description</label>
            <textarea className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
          </div>
          <h6 style={{ color:'#32be8f'}}><img src={upimage} alt="Responsive" /> Upload image</h6>
          <input type="file" name="files" id="files" onChange={this.fileSelectHandler} accept="image/*" multiple />
          {errmsg}
          <button className="bton btn-primary submit-btn" type="submit"> Submit </button>
        </form>
        <br />
      </div>
    )
