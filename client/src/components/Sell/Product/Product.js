                ...
                <div className="bttns">
                  <dl className="row">
                    <dt className="col-sm-0">
                      <button type="button " className=" bton btn btn-default " onClick={handleDelete}>
                    ...
                    <dt className="col-sm-3">
                      <button type="button" className=" bton btn btn-default" onClick={getInterestedUsers} data-toggle="modal" data-target={"#exampleModal" + this.props.item._id}>
                        <img src="https://img.icons8.com/ios-glyphs/24/000000/visible.png" />
                      </button>
                      </dt>
                      
                      <dt>
                      <button type="button" className="bton btn btn-default" onClick={() => { }} data-toggle="modal" data-target={"#commentsModal" + this.props.item._id}>
