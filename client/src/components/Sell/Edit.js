...
class Edit extends Component {
  ...
  render() {
    return (
      <div>
        <button type="button" className="bton btn btn-default" onClick={this.onOpenModal} style={{ marginRight: "5px" ,marginLeft: "5px"}}data-toggle="modal" data-target={"#edititem" + this.props.item._id} >
