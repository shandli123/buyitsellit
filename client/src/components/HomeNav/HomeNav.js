  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
        ...
        <div className="logoname" style={{ color: '#38d39f'}}>
        Buy !t Sell !t
        </div>
        <div className="collapse navbar-collapse" id="navbarToggler">
          <ul className="navbar-nav homenav">
            <li className={"nav-item " + this.state.status[0]}>
              <Link to={{ pathname: "/", state: { key: 0 } }} className="nav-link" style={{ color: '#38d39f' }}>Home</Link>
            </li>
            <li className={"nav-item " + this.state.status[1]}>
              <Link to={{ pathname: "/buy", state: { key: 1 } }} className="nav-link" style={{ color: '#38d39f' }}>Buy</Link>
            </li>
            <li className={"nav-item " + this.state.status[2]}>
              <Link to={{ pathname: "/sell", state: { key: 2 } }} className="nav-link" style={{ color: '#38d39f' }}>Sell</Link>
            </li>
            ...
            <li className={"nav-item " + this.state.status[4]}>
              <Link to={{ pathname: "/user", state: { key: 4 } }} className="nav-link" style={{ color: '#38d39f' }}>User</Link>
            </li>
            <li className="nav-item">
              <a className="nav-link" style={{ right: "25px" }} href="" onClick={this.logOut} style={{ color: '#38d39f' }}>Logout</a> 
            </li>
            <li>
              <div className="dropdown">
                <button className="bton btn-dark dropdown-toggle notification-dropdown-button" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onClick={this.notificationHandler}>
